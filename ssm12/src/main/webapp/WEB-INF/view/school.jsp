...
<body class="gray-bg">
        ...
        <div class="row">
			  <div class="col-lg-2">
				<div class="input-group">
			      ...
			      <input type="text" name="pream" class="form-control" id="txt_search_pream" >
				</div>
			  </div>
				...
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveSchool.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr><td>分校状态:</td>
							<td><input type="radio" id="status" name="status" value="启用" checked="checked">启用 
							<input type="radio" id="status" name="status" value="倒闭">倒闭</td>
							</tr>
	...
	<div class="modal fade" id="modal_user_import" role="dialog" aria-labelledby="modal_user_edit" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_import" method="post" enctype="multipart/form-data" action="importSchool.htm">
						<input type="hidden" name="id" id="hidden_txt_userid" value=""/>
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								<td>请选择文件：</td>
								<td><input type="file" id="schoolFile" name="schoolFile"></td>
							</tr>
						</table>
